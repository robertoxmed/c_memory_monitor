...
Les résultats montrent une augmentation de 14\% sur le temps d'exécution pour la tâche temps-réel quand on ajoute un attaquant et une augmentation de 35\% avec deux attaquants.
Pour la tâche temps-réel seule, le temps d'exécution est environ de 55 secondes, avec un attaquant on monte à 64 secondes et avec trois attaquants on arrive jusqu'à 89 secondes.
...
En comparaison le nombre d'accès mémoire augmente d'un facteur 3.16 avec un attaquant et 1.09 pour deux attaquants.
